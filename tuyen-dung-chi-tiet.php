...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/tuyen-dung-chi-tiet.css">
    <script src="js/tuyen-dung-chi-tiet.js" type="text/javascript"></script>
</head>
<body>
    <!-- BEGIN HEADER -->
        ...
        <div class="p_header">
            <div class="container">
                <div class="c-headline-2 h2">
                    <h2 class="c_name">tuyển dụng chi tiết</h2>
    ...
    <div class="p-detail-3">
        <div class="container">
            <div class="p_box">
                <h1 class="p_title">Tuyển dụng nhân viên bán nhang</h1>
                <ul class="p_source align-items">
                    ...
                    <li class="date"><span class="fa fa-calendar">30/02/2022</span></li>
                </ul>
                <ul class="p_job">
                        <li><span class="fa fa-user"><span>Vị trí: </span><span>Nhân viên</span></span></li>
                        <li><span class="fa fa-clock-o"><span>Kinh nghiệm: </span><span>không yêu cầu</span></span></li>
                        <li><span class="fa fa-money"><span>Mức lương: </span><span>10 triệu</span></span></li>
                        <li><span class="fa fa-map-marker"><span>Làm việc tại: </span><span>TP. HCM</span></span></li>
                    </ul>
                <div class="ht-format-detail">
                    <p class="text-center"><img src="images/news/2.webp" alt=""><br>
                    ...
                    <p>Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp.</p>
                    <p class="text-center"><img src="images/news/1.webp" alt=""><br>
                    <p>Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp.</p>
                    <p>Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp. Nội dung chi tiết bài viết của doanh nghiệp.</p>
                </div>
                <div class="form ht-mrt30">
                    <div class="text-center  ht-mrb30">
                        <h2 class="c_name">Ứng tuyển ngay</h2>
                    </div>
                    <form id="form_s-form-2" action="" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="row row-flex">
                            ...
                            <div class="col-12">
                                <div class="form-group c-form-border c-form-border--icon is-empty">
                                    <span class="c_icon c_icon--top"><i class="fa fa-info-circle" aria-hidden="true"></i></span>
                                    <textarea name="content" class="c_input" rows="3" placeholder="Thông tin thêm"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group text-center"><button type="submit" class="c-button-8">Gửi</button></div>
                    </form>
                </div>
            </div>
        </div>
