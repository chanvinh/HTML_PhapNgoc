        ...
        <div class="container-fluid">
            <div class="p_contact">
                <ul class="p_contact-info">
                    <li><h1><span class="fa-abs-top">Siêu thị Phật giáo quốc tế</span></h1></li>
                ...
                <form id="form_contact" action="" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
                    ...
                    <div class="form-group text-center"><button type="submit" class="c-button-8 c-btn--primary">Gửi</button></div>
                </form>
            </div>
        </div>
    </div>
